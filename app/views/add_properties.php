                        ...
                        <DIV CLASS="form-group has-feedback">
                            ...
                            <DIV CLASS="msg-validation">
                                <SELECT CLASS="form-control" NAME="properties-type" id="properties-type" REQUIRED>
                                    <OPTION VALUE="">Selecione um segmento para continuar</OPTION>
                                </SELECT>
                            </DIV>
                            <SPAN CLASS="fa form-control-feedback"></SPAN>
                            <DIV CLASS="help-block with-errors"></DIV> 
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <DIV CLASS="form-group has-feedback">
                            ...
                            <DIV CLASS="msg-validation">
                              <DIV CLASS="input-group">
                                  ...
                                  <input class="form-control" type="text" name="properties-value-total" placeholder="Exemplo: 180.435,00" data-control="mask-money" id="properties-value-total">
                              </DIV>
                            </DIV>
                            <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                            <DIV CLASS="help-block with-errors"></DIV> 
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                              <label>
                                 <input type="checkbox" name="properties-hidden-value-total" id="properties-hidden-value-total"> Deixar valor sob consulta
                              </label>
                            </div>
                        </div>
                        ...
                        <DIV CLASS="form-group has-feedback">
                            ...
                            <DIV CLASS="msg-validation">
                              <DIV CLASS="input-group">
                                  <SPAN CLASS="input-group-addon hidden-xs">$</SPAN>
                                  <input class="form-control" type="text" name="properties-value-monthly" placeholder="Exemplo: 435,00" data-control="mask-money" id="properties-value-monthly">
                              </DIV>
                            </DIV>
                            <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                            <DIV CLASS="help-block with-errors"></DIV> 
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                              <label>
                                 <input type="checkbox" name="properties-hidden-value-monthly" id="properties-hidden-value-monthly"> Deixar valor do aluguel sob consulta
                              </label>
                            </div>
                        </div>
                        ...
                        <p><Strong>Se for por temporada, o valor refere-se à:</Strong></p>
                         <div class="row">
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                  <div class="radio">  
                                      <label>
                                           <input type="radio" name="properties-value-refers" value="daily"> Valor diário
                                      </label>
                                  </div>
                              </div>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                  <div class="radio">  
                                      <label>
                                           <input type="radio" name="properties-value-refers" value="weekly"> Valor semanal
                                      </label>
                                  </div>
                              </div>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                  <div class="radio">  
                                      <label>
                                           <input type="radio" name="properties-value-refers" value="biweekly"> Valor quinzenal
                                      </label>
                                  </div>
                              </div>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                  <div class="radio">  
                                      <label>
                                           <input type="radio" name="properties-value-refers" value="monthly"> Valor mensal
                                      </label>
                                  </div>
                              </div>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                  <div class="radio">  
                                      <label>
                                           <input type="radio" name="properties-value-refers" value="other"> Outro
                                      </label>
                                  </div>
                              </div>
                         </div>
                        ...
                        <DIV CLASS="form-group has-feedback">
                            ...
                            <DIV CLASS="msg-validation">
                              <DIV CLASS="input-group">
                                  <SPAN CLASS="input-group-addon hidden-xs">$</SPAN>
                                  <input class="form-control" type="text" name="properties-condominium-value" placeholder="0,00" data-control="mask-money" id="properties-condominium-value">
                              </DIV>
                            </DIV>
                            <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                            <DIV CLASS="help-block with-errors"></DIV> 
                        ...
                        <div class="checkbox">  
                          <label>
                             <input type="checkbox" name="properties-hidden-condominium-value" id="properties-hidden-condominium-value" data-control="remove-required" data-action="#properties-hidden-condominium-value"> Deixar sob consulta
                          </label>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="text" name="properties-total-area" placeholder="m²" id="properties-total-area" pattern="[0-9,]+$">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="text" name="properties-construct-area" placeholder="m²" id="properties-construct-area" pattern="[0-9,]+$">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="number" name="properties-number-rooms" value="" id="properties-number-rooms" pattern="[0-9]+$">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="number" name="properties-number-bathrooms" value="" id="properties-number-bathrooms" pattern="[0-9]+$">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="number" name="properties-number-garage" value="" id="properties-number-garage" pattern="[0-9]+$">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="number" name="properties-number-suites" value="" id="properties-number-suites" pattern="[0-9]+$">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                        ...
                        <DIV CLASS="form-group has-feedback">
                            ...
                            <DIV CLASS="msg-validation">
                              <DIV CLASS="input-group date" data-control="datepicker">
                                  ...
                                  <input class="form-control" type="text" name="properties-finalization-date" id="properties-finalization-date" data-control="mask-date">
                              </DIV>
                            </DIV>
                            <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                            <DIV CLASS="help-block with-errors"></DIV> 
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">               
                                    <div class="form-group">
                                        <div class="checkbox">
                                          <label>
                                             <input type="checkbox" name="properties-save-coords" id="properties-save-coords"> Desejo guardar essas informações e exibir em meu site
                                          </label>
                                        </div>
                                    </div>
                                </div> 
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <DIV CLASS="form-group has-feedback">
                            <LABEL FOR="properties-address-state"><SPAN CLASS="required">*</SPAN> Estado</LABEL>
                            <DIV CLASS="msg-validation">
                                <SELECT CLASS="form-control" NAME="properties-address-state" id="properties-address-state" required>
                        ...
                        <DIV CLASS="form-group has-feedback">
                            <LABEL FOR="properties-address-city"><SPAN CLASS="required">*</SPAN> Cidade</LABEL>
                            <DIV CLASS="msg-validation">
                                <SELECT CLASS="form-control" NAME="properties-address-city" id="properties-address-city" required>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="text" name="properties-address-street" id="properties-address-street">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="text" name="properties-address-number" id="properties-address-number">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="text" name="properties-address-neighborhood" id="properties-address-neighborhood">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    <LABEL FOR="properties-address-postal-code"><SPAN CLASS="required">*</SPAN> CEP</LABEL>
                                    <DIV CLASS="msg-validation">
                                        <input class="form-control" type="text" name="properties-address-postal-code" id="properties-address-postal-code" data-control="mask-postal-code">
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                                </DIV>
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-hospital">
                                <div class="mini-box-near" tabindex= "0" role= "button" DATA-CONTROL="popover-hover" DATA-PLACEMENT="auto" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="focus" data-title="false" DATA-CONTENT="Hospital">
                                    ...
                                    <input type="checkbox" name="near-hospital" id="near-hospital" data-control="near" class="hidden-checkbox">
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-restaurant">
                                <div class="mini-box-near" tabindex= "0" role= "button" DATA-CONTROL="popover-hover" DATA-PLACEMENT="auto" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="focus" data-title="false" DATA-CONTENT="Restaurante">
                                    ...
                                    <input type="checkbox" name="near-restaurant" id="near-restaurant" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-bakery">
                                <div class="mini-box-near" tabindex= "0" role= "button" DATA-CONTROL="popover-hover" DATA-PLACEMENT="auto" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="hover" data-title="false" DATA-CONTENT="Cafeteria/Padaria">
                                    ...
                                    <input type="checkbox" name="near-bakery" id="near-bakery" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-road">
                                <div class="mini-box-near" tabindex= "0" role= "button" DATA-CONTROL="popover-hover" DATA-PLACEMENT="auto" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="focus" data-title="false" DATA-CONTENT="Terminal Rodoviário">
                                    ...
                                    <input type="checkbox" name="near-road" id="near-road" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-fuel">
                                <div class="mini-box-near" tabindex= "0" role= "button" DATA-CONTROL="popover-hover" DATA-PLACEMENT="auto" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="focus" data-title="false" DATA-CONTENT="Posto de Combustível">
                                    ...
                                    <input type="checkbox" name="near-fuel" id="near-fuel" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-fast-food">
                                <div class="mini-box-near" tabindex= "0" role= "button" DATA-CONTROL="popover-hover" DATA-PLACEMENT="auto" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="focus" data-title="false" DATA-CONTENT="Fast Food">
                                    ...
                                    <input type="checkbox" name="near-fast-food" id="near-fast-food" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-beach">
                                <div class="mini-box-near" tabindex= "0" role= "button" DATA-CONTROL="popover-hover" DATA-PLACEMENT="auto" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="focus" data-title="false" DATA-CONTENT="Praia">
                                    ...
                                    <input type="checkbox" name="near-beach" id="near-beach" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-summer-club">
                                ...
                                <img src="/app/images/icons/properties-icons/swimming-pool.png" class="img-reponsive">
                                    <input type="checkbox" name="near-summer-club" id="near-summer-club" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-airport">
                                ...
                                <img src="/app/images/icons/properties-icons/departure.png" class="img-reponsive">
                                    <input type="checkbox" name="near-airport" id="near-airport" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-school">
                                ...
                                <img src="/app/images/icons/properties-icons/blackboard.png" class="img-reponsive">
                                    <input type="checkbox" name="near-school" id="near-school" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-university">
                                ...
                                <img src="/app/images/icons/properties-icons/mortarboard.png" class="img-reponsive">
                                    <input type="checkbox" name="near-university" id="near-university" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-shopping">
                                ...
                                <img src="/app/images/icons/properties-icons/shopping-bag.png" class="img-reponsive">
                                    <input type="checkbox" name="near-shopping" id="near-shopping" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-supermarket">
                                ...
                                <img src="/app/images/icons/properties-icons/cart.png" class="img-reponsive">
                                    <input type="checkbox" name="near-supermarket" id="near-supermarket" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-park">
                                ...
                                <img src="/app/images/icons/properties-icons/park.png" class="img-reponsive">
                                    <input type="checkbox" name="near-park" id="near-park" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-drogstore">
                                ...
                                <img src="/app/images/icons/properties-icons/drugs.png" class="img-reponsive">
                                    <input type="checkbox" name="near-drogstore" id="near-drogstore" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-academy">
                                ...
                                <img src="/app/images/icons/properties-icons/dumbbell.png" class="img-reponsive">
                                    <input type="checkbox" name="near-academy" id="near-academy" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-bank">
                                ...
                                <img src="/app/images/icons/properties-icons/bank.png" class="img-reponsive">
                                    <input type="checkbox" name="near-bank" id="near-bank" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-police">
                                ...
                                <img src="/app/images/icons/properties-icons/police-car.png" class="img-reponsive">
                                    <input type="checkbox" name="near-police" id="near-police" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-4">
                            <label for="near-firefighter">
                                ...
                                <img src="/app/images/icons/properties-icons/firefighter.png" class="img-reponsive">
                                    <input type="checkbox" name="near-firefighter" id="near-firefighter" data-control="near" class="hidden-checkbox">
                                    <i class="fa fa-check"></i>
                                </div>
                            </label>
                        </div><!--/.col-3 item -->
            ...
            <div class="col-md-12">
            	<div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <TEXTAREA NAME="properties-details" CLASS="tiny"  ID="properties-details" STYLE="resize:none; min-height: 255px"></TEXTAREA>
