<?php
if( $_SESSION['user_type'] == 'administrador' or $_SESSION['user_type'] == 'suporte' or isset($_SESSION['clients_edit']))
{
                    ...
                    <div class="row"> 
                        <DIV CLASS="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <DIV CLASS="form-group has-feedback">
                                ...
                                <DIV CLASS="msg-validation">
                                    <input type="text" class="form-control" name="client-fantasy-name" id="client-fantasy-name" data-control="input-juridical" value="<?php echo $fantasy_name ?>"  <?php echo ($type === 'physical') ? 'disabled' : 'REQUIRED'; ?> >
                                </DIV>
                                <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                <DIV CLASS="help-block with-errors"></DIV>            
                            </DIV>
                    ...
                    <div class="row">   
                        <DIV CLASS="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <DIV CLASS="form-group has-feedback">
                                ...
                                <DIV CLASS="msg-validation">
                                    <input type="text" class="form-control" name="client-name" id="client-name" data-control="input-physical" value="<?php echo $name ?>"  <?php echo ($type === 'juridical') ? 'disabled' : 'REQUIRED'; ?> >
                                </DIV>
                                <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                <DIV CLASS="help-block with-errors"></DIV>            
                            </DIV>
                        ...
                        <DIV CLASS="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <DIV CLASS="form-group has-feedback">
                                ...
                                <DIV CLASS="msg-validation">
                                    <input type="text" class="form-control" name="client-last-name" id="client-last-name" data-control="input-physical" value="<?php echo $last_name ?>"  <?php echo ($type === 'juridical') ? 'disabled' : 'REQUIRED'; ?> >
                                </DIV>
                                <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                <DIV CLASS="help-block with-errors"></DIV>            
                            </DIV>
                        ...
                        <DIV CLASS="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <DIV CLASS="form-group has-feedback">
                                ...
                                <div class="radio-inline">
                                    <label>
                                      <input name="client-genre" value="male" type="radio" data-control="input-physical" <?php echo ($genre === 'male') ? 'checked' : '' ; ?>  <?php echo ($type === 'juridical') ? 'disabled' : 'required'; ?> >
                                      Masculino
                                    </label>
                                </div>
                                <div class="radio-inline">
                                    <label>
                                      <input name="client-genre" value="female" type="radio" data-control="input-physical" <?php echo ($genre === 'female') ? 'checked' : '' ;?>  <?php echo ($type === 'juridical') ? 'disabled' : 'required'; ?> >
                                      Feminino
                                    </label>
                                </div>
                                <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                    ...
                    <div class="row"> 
                        ...
                        <DIV CLASS="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <DIV CLASS="form-group has-feedback">
                                ...
                                <DIV CLASS="msg-validation">
                                    <input type="text" class="form-control" name="client-rg" id="client-rg" pattern="[0-9]+$" value="<?php echo $rg ?>" <?php echo ($type === 'juridical') ? 'disabled' : ''; ?> >
                                </DIV>
                                <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                <DIV CLASS="help-block with-errors"></DIV>            
                            </DIV>
                     ...
                     <div class="row"> 
                        ...
                        <DIV CLASS="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <DIV CLASS="form-group has-feedback">
                                ...
                                <DIV CLASS="msg-validation">
                                    <input type="text" class="form-control" name="client-nationality" id="client-nationality" data-control="input-physical" value="<?php echo $nationality ?>"  <?php echo ($type === 'juridical') ? 'disabled' : 'REQUIRED'; ?> >
                                </DIV>
                                <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                <DIV CLASS="help-block with-errors"></DIV>            
                            </DIV>
                     ...
                     <DIV CLASS="form-group has-feedback">
                        ...
                        <div class="radio-inline">
                            <label>
                              <input name="client-is-employed" id="client-is-employed" value="S" type="radio" data-control="input-physical" <?php echo ($employed === 'Y') ? 'checked' : '' ; ?>  <?php echo ($type === 'juridical') ? 'disabled' : 'required'; ?> >
                              Sim
                            </label>
                        </div>
                        ...
                        <div class="radio-inline">
                            <label>
                              <input name="client-is-employed" id="client-is-employed" value="N" type="radio" data-control="input-physical" <?php echo ($employed === 'N') ? 'checked' : '' ; ?>  <?php echo ($type === 'juridical') ? 'disabled' : 'required'; ?> >
                              Não
                            </label>
                        </div>
                        <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                     ...
                     <div class="row"> 
                        ...
                        <DIV CLASS="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <DIV CLASS="form-group has-feedback">
                                ...
                                <DIV CLASS="msg-validation">
                                    <input type="text" class="form-control" data-input-control="tel" name="client-company-contact" id="client-company-contact" data-control="mask-tel" value="<?php echo $company_contact ?>"	 <?php echo ($employed === 'N') ? 'disabled' : '' ; ?> <?php echo ($type === 'juridical') ? 'disabled' : ''; ?> >
                                </DIV>
                                <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                <DIV CLASS="help-block with-errors"></DIV>            
                            </DIV>
