...
<SECTION CLASS="container-fluid">
    <DIV CLASS="row">
        ...
        <form name="form-add-contracts" method="POST" id="form-add-contracts" action="/app/modules/contracts/insert_contracts.php" role="form" DATA-TOGGLE="validator" enctype="APPLICATION/X-WWW-FORM-URLENCODED" NOVALIDATE data-action="submit-ajax" data-form-reset="reset" autocomplete="off">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    <LABEL FOR="client-tenant"><SPAN CLASS="required">*</SPAN> Cliente (comprador ou locatário):</LABEL>
                                    <DIV CLASS="msg-validation">
                                      <SELECT CLASS="form-control" NAME="client-tenant" id="client-tenant" REQUIRED>
                                        <?php echo  listClients(); ?>
                                      </SELECT>
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    ...
                                    <div CLASS="pull-right ico-help icons_sys" id="sprites-support" tabindex= "0" role= "button" DATA-CONTROL="popover-focus"  DATA-PLACEMENT="left" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="focus" TITLE="Ajuda" DATA-CONTENT="Deixe em branco caso a validade deste contrato seja indeterminada."></div>
                                    <DIV CLASS="msg-validation">
                                      <DIV CLASS="input-group date" data-control="datepicker">
                                          <SPAN CLASS="input-group-addon hidden-xs"><i class="fa fa-calendar"></i></SPAN>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    <LABEL FOR="contract-value"><SPAN CLASS="required">*</SPAN> Valor do contrato:</LABEL>
                                    <DIV CLASS="msg-validation">
                                      <DIV CLASS="input-group">
                                        <SPAN CLASS="input-group-addon hidden-xs">$</SPAN>
                                        <input class="form-control" type="text" name="contract-value" id="contract-value" placeholder="Exemplo: 700,00" data-control="mask-money" REQUIRED>
                                      </DIV>
                                    </DIV>
                                    <SPAN CLASS="fa form-control-feedback" ARIA-HIDDEN="true"></SPAN>
                                    <DIV CLASS="help-block with-errors"></DIV> 
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <DIV CLASS="form-group has-feedback">
                                    <LABEL for="contract-time-referer"> O valor do contrato se refere a um período de:</LABEL>
                                    <DIV CLASS="msg-validation">
                                      <SELECT CLASS="form-control" NAME="contract-time-referer" id="contract-time-referer"> 
                                        <OPTION VALUE="">Escolha uma oção</OPTION>
                                        <OPTION VALUE="daily">Diário</OPTION>
                                        <OPTION VALUE="weekly">Semanal</OPTION>
                                        <OPTION VALUE="biweekly">Qinzenal</OPTION>
